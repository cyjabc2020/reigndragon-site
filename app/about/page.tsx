...
export const metadata: Metadata = {
  title: "About",
  description:
    "About ReignDragon — the empirical safety lab for the AI workforce. We study how AI workers behave inside companies, markets, and institutions, and turn that evidence into governance that works.",
};
    ...
    <div className="bg-grid">
      <section className="mx-auto max-w-3xl px-6 pt-24 pb-12 sm:pt-32">
        ...
        <div className="space-y-6 text-text-secondary leading-relaxed text-lg">
          <p>
            ReignDragon is the empirical safety lab for the AI workforce. We
            study how AI workers behave inside companies, markets, governments,
            and platforms &mdash; and translate that evidence into governance
            that works.
          </p>
          <p>
