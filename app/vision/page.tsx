...
export const metadata: Metadata = {
  title: "Vision",
  description:
    "Build the institutional science of the AI workforce. ReignDragon Institute studies how AI workers behave inside companies, markets, and institutions — and turns that evidence into governance that works.",
};
    ...
    <div className="bg-grid">
      ...
      <section className="mx-auto max-w-3xl px-6 py-16 sm:py-20">
        ...
        <div className="space-y-6 text-text-secondary leading-relaxed">
          <p>
            ReignDragon Institute studies how AI workers actually behave &mdash; in
